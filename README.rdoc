...
* cairo >= 1.2.0 (1.8.10 also supported!)
...
* cairo related binaries:
  ...
  * cairo-X.Y.Z-win32.zip
  * cairo-dev-X.Y.Z-win32.zip
  * libpng-X.Y.Z-win32.zip
  * libpng-dev-X.Y.Z-win32.zip
  * zlib-X.Y.Z-win32.zip
  * zlib-dev-X.Y.Z-win32.zip
